package com.itheima.apisflorea;

import com.itheima.apisflorea.activity.MainActivity;
...
import com.itheima.apisflorea.listener.AddBoomListener;
import com.itheima.apisflorea.listener.AddBulletListener;
import com.itheima.apisflorea.listener.AddEnemyListener;
import com.itheima.apisflorea.listener.AddHeroListener;
import com.itheima.apisflorea.util.SharePrefUtil;
import com.itheima.apisflorea.util.SharePrefUtil.KEY;
 ...
 * 
 */
public class ApisFlorea extends FrameLayout {
	...
	public ApisFlorea(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public ApisFlorea(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public ApisFlorea(Context context) {
		super(context);
		init();
	}
